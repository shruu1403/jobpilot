  ...
  return (
    <div className="min-h-screen bg-[#0B1220] flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="flex flex-col items-center gap-4 mb-10 relative z-10">
        <Image src="/logo.png" alt="JobPilot Logo" width={54} height={54} className="rounded-2xl shadow-[0_0_30px_rgba(59,130,246,0.5)]" />
        <h1 className="text-3xl font-black text-white tracking-widest uppercase italic">JobPilot</h1>
      </div>

      {/* Main Card */}
      <div className="w-full max-w-[480px] bg-[#111827] border border-white/5 rounded-[32px] p-10 relative z-10 shadow-2xl backdrop-blur-xl">
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold text-white mb-2">Create Account</h2>
          <p className="text-muted-text font-medium">Join the AI career revolution</p>
        </div>
        ...
        <div className="flex items-center gap-4 my-8">
          ...
          <span className="text-[10px] font-black text-muted-text uppercase tracking-widest leading-none">Or use email</span>
          <div className="flex-1 h-[1px] bg-white/5" />
        </div>
        ...
        <div className="space-y-6">
          ...
          >
            {loading ? <Loader2 size={18} className="animate-spin" /> : 'Start Your Journey'}
          </button>
        </div>

        {/* Footer */}
        <p className="text-center mt-10 text-muted-text font-medium text-[15px]">
