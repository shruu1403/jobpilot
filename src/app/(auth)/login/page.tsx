...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-[#0B1220] flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      {/* Brand Header */}
      <div className="flex flex-col items-center gap-4 mb-10 relative z-10 transition-all duration-700 animate-in fade-in slide-in-from-top-4">
      ...
      <div className="w-full max-w-[480px] bg-[#111827] border border-white/5 rounded-[32px] p-10 relative z-10 shadow-2xl backdrop-blur-xl animate-in zoom-in duration-500">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-text font-medium text-[15px]">Access your AI-powered career suite</p>
        </div>
        ...
        <div className="flex items-center gap-4 my-8">
          ...
          <span className="text-[10px] font-black text-muted-text uppercase tracking-[0.25em] leading-none">Or use email</span>
          <div className="flex-1 h-[1px] bg-white/5" />
        </div>
